...
sfc1 = SFC(dimensions = np.array([[633.33], [133.33],[300]]),
           translation = np.array([[250], [0],[-150]]),
           rotation = np.identity(3))
sfc2 = SFC(dimensions = np.array([[133.33], [633.33],[300]]),
           translation = np.array([[166.66], [250],[-150]]),
           rotation = np.identity(3))
sfc3 = SFC(dimensions = np.array([[633.33], [133.33],[300]]),
           translation = np.array([[250], [166.66],[-150]]),
           rotation = np.identity(3))
sfc4 = SFC(dimensions = np.array([[133.33], [633.33],[300]]),
           translation = np.array([[333.33], [250],[-150]]),
           rotation = np.identity(3))
sfc5 = SFC(dimensions = np.array([[633.33], [133.33],[300]]),
           translation = np.array([[250], [333.33],[-150]]),
           rotation = np.identity(3))
sfc6 = SFC(dimensions = np.array([[133.33], [633.33],[300]]),
           translation = np.array([[500], [250],[-150]]),
           rotation = np.identity(3))
...
waypoint_b = Waypoint(location=np.array([[500],[500],[-100]]), velocity = np.array([[0],[1],[0]])*velocity_scale)
