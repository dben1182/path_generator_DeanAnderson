...
from path_generation.obstacle import Obstacle, plot_3D_obstacle, set_axes_equal
import time
...
waypoint_directions = None # np.array([[1,0],[0,1],[0,0]])
...
max_curvature = 0.5
max_incline = None
obstacle = Obstacle(np.array([[5],[6],[6]]), 3.0)
order = 3
...
control_points = path_gen.generate_path(point_sequence, waypoint_directions, waypoint_curvatures, 
                                        max_curvature, max_incline=max_incline, sfcs=None, obstacle=obstacle)
end_time = time.time()
