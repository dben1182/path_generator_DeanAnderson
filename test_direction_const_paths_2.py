...
# create first path
waypoint_directions_1 = np.array([[1,0],[1,-1],[0,1]])
...
control_points_1, scale_factor = path_gen.generate_path(point_sequence_1, waypoint_directions_1, waypoint_accelerations_1, 
