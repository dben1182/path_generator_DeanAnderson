...
sfc_1 = SFC(np.array([[min_len_1+4],[2]]), T1, R1)
sfc_2 = SFC(np.array([[min_len_2+2],[4]]), T2, R2)
sfc_3 = SFC(np.array([[min_len_3+4],[2]]), T3, R3)
sfcs = [sfc_1, sfc_2, sfc_3]
sfc_data_1b = SFC_Data(sfcs,point_sequence)
obstacles_1b = None
#Sfcs and obstalce case 1c
sfc_data_1c = sfc_data_1b
obstacle = Obstacle(center=np.array([[6],[4]]), radius=1)
